...
from gym_chrono.train.rassorActorCritic import CustomCombinedExtractor
...
if __name__ == '__main__':
    ...
    policy_kwargs = dict(
        ...
        net_arch=dict(activation_fn=th.nn.ReLU, pi=[32, 64, 32, 10], vf=[32, 64, 32, 10]))
    ...
    checkpoint_dir = 'rassor_ppo_checkpoints'
